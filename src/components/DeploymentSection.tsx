    ...
    <section className="py-20 px-4 bg-gradient-to-br from-primary/5 via-background to-primary/10">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-12 grid-rows-6 gap-4 h-[800px]">
          ...
          <div 
            className="col-span-6 row-span-4 group relative animate-fade-in"
          ...
          {[1, 2].map((index) => (
            <div 
              key={index}
              className="col-span-3 row-span-2 group relative animate-fade-in"
              style={{ animationDelay: features[index].delay }}
            >
          ...
          {[3, 4].map((index) => (
            <div 
              key={index}
              className="col-span-6 row-span-2 group relative animate-fade-in"
              style={{ animationDelay: features[index].delay }}
            >
          ...
          <div 
            className="col-span-3 row-span-2 group relative animate-fade-in"
            style={{ animationDelay: features[5].delay }}
          >
            <div className="relative h-full p-6 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 hover:border-white/20 transition-all duration-500 hover:bg-white/10 hover:scale-105">
              <div className="p-3 rounded-xl bg-primary/20 backdrop-blur-sm w-fit mb-4">
                {(() => {
